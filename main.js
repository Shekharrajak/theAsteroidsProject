...
function sketchProc(processing) {
	...
	processing.draw = function(tickTime) {
        ...
        //how can I get this collisoin detectoin loop in some sort of functoin of calss?
        for(var i=0; i<window.ship.shots.length; i+=1){
            asteroidHit = window.asteroidsManager.detectCircularCollision(window.ship.shots[i].position, window.ship.shots[i].size);
            if(asteroidHit!==-1){
